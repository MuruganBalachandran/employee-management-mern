...
/**
 * Checks if a value is truly empty/invalid
 * Returns true for: undefined, null, empty string, empty object, empty array
 */
const isEmpty = (value) => {
...
/**
 * Checks if value is falsy or invalid for validation purposes
 * Catches: undefined, null, '', false, 0, NaN, {}, []
 */
...
/**
 * General validation check for required fields
 * @param {*} value - Value to validate
 * @param {string} fieldName - Name of field for error message
 * @param {string} expectedType - Expected type ('string', 'number', 'object', 'boolean')
 * @returns {string|null} - Error message or null if valid
 */
const validateRequired = (value, fieldName = 'Field', expectedType = 'string') => {
...
/**
 * Validates that the email domain matches the required domain for the role.
 * Admin/SuperAdmin -> @spanadmin.com
 * Employee -> @spanemail.com
 */
